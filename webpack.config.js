...
var arrayEntry = {
    ...
    'module/easyData/index':['./src/module/easyData'],
        ...
        'module/easyData/close/index':['./src/module/easyData/close'],
        'module/easyData/effective/index':['./src/module/easyData/effective'],
        'module/easyData/match/index':['./src/module/easyData/match'],
        'module/easyData/opponent/index':['./src/module/easyData/opponent'],
        'module/easyData/tarck/index':['./src/module/easyData/tarck'],
